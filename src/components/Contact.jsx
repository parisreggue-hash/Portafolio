    ...
    <section id="contacto" className="relative py-32 overflow-hidden transition-colors duration-500">
      ...
      >
        <div className="section-reveal" ref={ref}>
          ...
          <h2
            className="font-display font-black leading-tight mt-4 mb-4 transition-colors duration-500"
            style={{ fontSize: 'clamp(2.5rem, 7vw, 6rem)', color: m.text }}
          >
            Trabajemos
            <br />
            <span style={{ color: m.accent, textShadow: m.accentGlow }}>juntos.</span>
          </h2>

          <p
            className="font-body text-base max-w-md mx-auto leading-relaxed mb-12 transition-colors duration-500"
            style={{ color: m.textMuted }}
          >
            Necesitas una página web? Escríbeme y te respondo lo antes posible.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <a
              ...
              className="flex items-center gap-3 px-8 py-4 rounded-xl font-semibold text-sm transition-all duration-200"
              style={{
                background: m.accent,
